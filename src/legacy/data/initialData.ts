...
export const INITIAL_PLAYERS: Player[] = [
  {
    ...
    club: 'Tennis Conde 2 - Quadras Oficiais',
...
export const INITIAL_TOURNAMENTS: Tournament[] = [
  {
    id: 'tour1',
    title: 'Torneio Aberto Tennis Conde 2 (2026)',
    ...
    category: '1ª Classe (Pro/Avançado)',
    surface: 'Saibro (Clay)',
    clubName: 'Tennis Conde 2 - Residencial Conde II',
    address: 'Alameda dos Ipês, Quadras de Tênis - Conde 2',
